...
\begin{abstract}%{{{1
ff sadf sadf sd gfdsf gsd fg fdsg dsg dsg ds gds g dsfg dsg dsf g dsfg dssg dblablabl s sgddsf g dsg dsgds gs gdsa
\end{abstract}%}}}1

\title{ Project 1, Fys 4411}
\author{Karl R. Leikanger}
\affiliation{University of Oslo, UIO}
...
This is simply a normal distribution with a shift $\ts r_n+D\Delta t \frac{\nabla P(\ts r_n)}{P(\ts r_n)}$
Samples from this density are generated using the %Langevin 
equation %on the form (ref HAMMOND) (exact ? or is this where the dt dependent error enters)
\begin{align}
	\ts r_{n+1}=\ts r_n+D\Delta t \frac{\nabla P(\ts r_n)}{P(\ts r_n)} + \sqrt{\Delta t}2D\mathcal N,	
	\label{rp1}
\end{align}
where $\mathcal N$ is a random normal distributed vector.
...
\subsection{Random number generators}%{{{2
...
%\subsection{Using the inverse $\mathcal D^{-1}$}%{{{2
\subsection{Optimizing the Slater}%{{{2
...
%\footnote{When calculating the determinants directly in only has to be evaluated once each time all particles are moved.}.
...
\subsection{Optimizing the Jastrow}%{{{2
...
\subsection{Implementing $(\partial_\alpha,\partial_\beta)\expec{E_L}$}%{{{2
...
The cpu time spent on running the code for $n_p=\{2$, $6$, $12$, $20\}$ particles is listed in table \ref{tab:scaletime}. 
A curve fit to this data indicates that the algorithm scales as $\mathcal O(n_p^{2.55})$. The theoretical limit is $\mathcal O(n_p^2)$
if one ignores the evaluation of the orbitals and their derivatives.
...
%This part of the code scales bad 
since the mathematical expressions for the orbitals eq. (\ref{1pts}) gets more complex as the orbital energies increases.
...
This did not pay off when I tried to implement it since the number of variables that has to be stored is too high ($1/2(n_p)^2$ for our system).
...
\begin{center}
%\vspace{.1cm}
	\includegraphics[width=7.9cm]{../plots/spds2pt.eps}
\caption{{\it%\small
...
\begin{figure*}[h!]
\begin{center}
	\includegraphics[width=13.5cm]{../plots/spds612.eps}
\caption{{\it%\small
		...
		showing strong correlations effects that can not be accounted for by the 2 particle Jastrow. %Note that the curves for $\omega =0.01$ and $1$ have the same shape... 
		}}
		\label{fig:spd612}
%\vspace{.1cm}
\end{center}
...
%		%Our Jastrow can no longer account for the important correlations 
%		}}
%		\label{fig:spd6}
%\vspace{-.7cm}
%	\includegraphics[width=8cm]{../plots/spds12pt.eps}
%\end{center}
%\vspace{-1.2cm}
%\end{figure}
...
%\begin{center}
%\caption{{\it%\small
%		The single particle densities for a twelve particle dot with $\omega=1$ (top plot) and $\omega=0.01$ (bottom plot). 
%		%Our Jastrow can no longer account for the important correlations 
%		}}
%		\label{fig:spd6}
%\vspace{-1.cm}
%	\includegraphics[width=8cm]{../plots/spds6pt.eps}
%\end{center}
%\vspace{-1.cm}
%\end{figure}
...
\begin{tabular}{|c|c|c|c|c|c|}
\hline
$N_{p}$ & $\omega$ & $\Delta_t$ &$\expec{E_L}$ \\ 
\hline
\hline
 $2$  & $1.0$ 	& $0.007$ & $3.00001(2)$ \\ 
 $2$  & $1$  & $0.005$ & $3.00000(2)$ \\ 
 $2$  & $1$  & $0.001$ & $3.00001(3)$ \\ 	 
\hline
 $2$  & $0.28$ 	& $0.007$ & $1.02167()$ \\ 
 $2$  & $0.28$  & $0.005$ & $1.02166()$ \\ 
 $2$  & $0.28$  & $0.001$ & $1.20167()$ \\ 	 
\hline
 $2$  & $0.01$ 	& $0.007$ & $0.07385()$ \\ 
 $2$  & $0.01$  & $0.005$ & $0.07386()$ \\ 
 $2$  & $0.01$  & $0.001$ & $0.07386()$ \\ 	 
\hline
 $6$  & $1.0$ 	& $0.9245$ & $0.5561$ \\ 
 $6$  & $0.28$  & $0.8736$ & $0.3259$ \\ 
 $6$  & $0.01$  & $0.6141$ & $0.09327$ \\ 
...
\hline
\hline
  &  			& $0.05$  & $3.00040(1)$ & $0.0018334$ 	& 			& 	 		& 				& $99.48\%$\\ 
$ 2 $ & $1.0$& $0.025$ & $3.00036(2)$ & $0.0018346$ 	& $29.7\%$ 	& $43.3\%$ 	& $27.1\%$ 		& $99.80\%$\\ 
  & 		 	& $0.01$  & $3.00035(3)$ & $0.0018411$ 	& 			& 			& 				& $99.95\%$\\ 
\hline
  	& 	 		& $0.05$   	& $1.02217(2)$ & $7.4875\times10^{-4}$ 	&    			&  			& 			& $99.91\%$\\ 
$2$ & $0.28$&  	$0.025$  	& $1.02218(2)$ & $7.4943\times10^{-4}$ 	& 	$24.7\%$ 	& $41.4\%$ 	& $33.9\%$ 	& $99.96$\\ 
  	& 	 		& $0.01$  	& $1.02213(3)$ & $7.5364\times10^{-4}$ 	& 			 	& 		 	&  			& $99.99\%$\\ 
\hline
  &  			& $0.05$   & $0.07407(1)$ & $9.9381\times10^{-6}$ 	& 				& 			& 			& $>99.99\%$\\ 
$2$&$0.01$ 	& $0.025$  & $0.07407(1)$ & $9.9323\times10^{-6}$ 		& $13.0\%$ 		& $37.6\%$ 	& $49.4\%$ 	& $>99.99\%$\\ 
  & 			& $0.01$   & $0.07406(2)$ & $9.8967\times10^{-6}$ 	&  				& 			& 			& $>99.99\%$\\ 
\hline
\hline
 	 & 			& $0.05$  & $20.1905(1)$ & $0.115568$ & 		 & 				& 		 & $98.81\%$\\ 
 $6$ & 	$1.0$	& $0.025$ & $20.1904(2)$ & $0.119353$ & $17.7\%$ & $39.3\%$ 	& $43.0\%$ 	& $99.52\%$\\ 
 	 & 		 	& $0.01$  & $20.1908(3)$ & $0.123143$ & 		 & 				&  	 		& $99.86\%$\\ 
\hline
 	 &  		& $0.05$  & $7.6216(1)$ & $0.017358$ &  		& 			& 			& $99.81\%$\\
 $6$ &  $0.28$	& $0.025$ & $7.6216(1)$ & $0.017655$ & $12.3\%$ & $37.4\%$ 	& $50.4\%$ 	& $99.92\%$\\ 
 	 & 			& $0.01$  & $7.6215(2)$ & $0.017838$ & 			& 			& 			& $99.98\%$\\ 
\hline
     &      	& $0.05$   & $0.6984(1)$ & $2.5323\times10^{-4}$ & 			& 			& 			&$>99.99\%$\\ 
 $6$ & $0.01$	& $0.025$  & $0.6984(1)$ & $2.5522\times10^{-4}$ & $3.9\%$ 	& $34.6\%$ 	& $61.4\%$ 	& $>99.99\%$\\ 
 	 & 			& $0.01$   & $0.6983(2)$ & $2.4233\times10^{-4}$ & 			& 			& 			& $>99.99\%$\\ 
\hline
\hline
 	 & 			& $0.05$  & $65.7906(2)$ & $0.40948$ & 			& 			& 			& $98.13\%$\\ 
 $12$& $1.0$ 	& $0.025$ & $65.7903(3)$ & $0.42128$ & $13.4\%$ & $37.8\%$ 	& $48.8\%$ 	& $99.22\%$\\ 
 	 & 			& $0.01$  & $65.7912(5)$ & $0.44123$ & 			& 			& 		 	& $99.76\%$\\ 
\hline
 	 & 	 		& $0.05$  & $25.6991(2)$ & $0.060032$ & 		& 			& 				&$99.70\%$\\ 
 $12$& 	$0.28$	& $0.025$ & $25.6991(3)$ & $0.061213$ & $8.5\%$ & $36.2\% 	$ & $55.3\%$ 	&$99.88\%$\\ 
 	 & 			& $0.01$  & $25.6996(4)$ & $0.062310$ &  		& 			& 				&$99.96\%$\\ 
\hline
 	  & 		& $0.05$  & $2.4980(2)$ & $9.0817\times10^{-4}$ & 	 		& 			& 		 	& $>99.99\%$\\ 
 $12$ & $0.01$	& $0.025$ & $2.4981(3)$ & $9.1378\times10^{-4}$ & $2.3\%$ 	& $33.3\%$ 	& $64.3\%$ 	& $>99.99\%$\\ 
 	  & 		& $0.01$  & $2.4980(4)$ & $8.9618\times10^{-4}$ &  			& 			& 			& $>99.99\%$\\ 
\hline
\hline
	& 	 	& $0.05$  & $155.9949(3)$ & $1.08344$ &  			& 			& 			&$95.83\%$\\ 
$20$& $1.0$	& $0.025$ & $155.9952(4)$ & $1.08273$ & $11.0\%$ 	& $37.0\%$ 	& $52.0\%$ 	&$97.41\%$\\ 
 	&  		& $0.01$  & $155.9946(6)$ & $1.13446$ & 			& 			& 			&$98.48\%$\\ 
\hline
	& 		& $0.05$   & $62.0391(3)$ & $0.14986$ &  		& 			& 			& $98.66\%$\\
$20$& $0.28$& $0.025$  & $62.0395(3)$ & $0.15339$ & $6.6\%$ & $35.6\%$ 	& $57.8\%$ 	& $99.01\%$\\ 	
	& 	 	& $0.01$   & $62.0398(6)$ & $0.15632$ & 		& 			& 			& $99.44$\\
\hline
	& 		& $0.05$  & $6.1996(3)$ & $0.0023159$ 	& 			& 			& 			& $93.49\%$\\
$20$&$0.01$ & $0.025$ & $6.2002(4)$ & $0.0023496$ 	&$1.6\%$ 	& $32.1\%$ 	& $66.3\%$ 	& $99.90\%$\\ 
	&  		& $0.01$  & $6.2002()$ & $0.0029175$ 	& 			& 			& 			& $99.93\%$\\ 
\hline
\end{tabular}
\end{center}
\caption{{\it 
	VMC results using the variational parameters in table (\ref{tab1}).
	Minimization results. $N_p$ is the number of particles and $N_s$ is the number of cycles used to obtain the energies and the gradient during the minimization.
	All results are obtained using $10^8$ MC - cycles. The error is estimated using blocking analysis of the data.
	The oscillator energies are quite stable, but the ratio between $E_{kin}$ and $E_{e-e}$ varies with $\omega$.
	* * * Generally, the lower this ratio is, the more important are the correlations not included in the Jastrow. See plots. 
	%(ref article that shows that this ratio and the correlation energy are correlated)
%The variable \verb gtol  which sets the convergence criteria
}}
\label{tab2}
%\hspace{50mm}
...
\section{Pseudocode: The SGA algorithm.}%{{{2
...
\STATE{$k_\beta\gets0,l_\beta\gets1$}
	\LOOP{}
		...
		\FOR{all walkers }
			...
			\STATE{sample $\left({\partial_\alpha},{\partial_\beta}\right) E_L ,E_L$, $({\partial_\alpha},{\partial_\beta}) E_L* E_L$}
		\ENDFOR{}
...
\section{Derivation of the analytical expressions for $(\partial_\alpha,\partial_\beta)\expec{\hat H}$}%{{{2
