...
vmcmain.o: $(PAT)/vmcmain/vmcmain.cpp
	$(CC) $(CFLAGS) -c $(PAT)/vmcmain/vmcmain.cpp $(LFLAGS)

sampler.o: $(PAT)/sampler/sampler.h $(PAT)/sampler/sampler.cpp walker.o
	$(CC) $(CFLAGS) -c $(PAT)/sampler/sampler.h $(PAT)/sampler/sampler.cpp $(LFLAGS)

walker.o: $(PAT)/walker/walker.h $(PAT)/walker/walker.cpp slaterMatrix.o orbital.o ipdist.o zignor.o zigrandom.o newmatrix.o
	$(CC) $(CFLAGS) -c $(PAT)/walker/walker.h $(PAT)/walker/walker.cpp $(LFLAGS)
