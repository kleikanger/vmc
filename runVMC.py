...
sampling_cycles 	= 2e5 #total number on all procs
thermal_cycles 		= 4e5
...
def gen_vmcmain_h():
	f_name_A='"%s%s"'%(filepath_var,time_now())
	os.system("echo '#define WRITEOFA %s'  > definitions/vmcmain_Def.h"%write_blocking_data)
...
a_inc=(min_alpha-max_alpha)/alpha_variations 
a_ini=min_alpha-a_inc
b_inc=(min_beta-max_beta)/beta_variations 
